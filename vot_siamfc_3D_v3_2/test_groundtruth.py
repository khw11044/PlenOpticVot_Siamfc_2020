...
parser.add_argument('-vn', '--video_name', default='C:/Repos/vot/2020VOT_SiamFC/data/Video3', type=str) 
...
def main():
    ...
    for i, frame in enumerate(get_frame1(root)):
        ...
        frame = cv2.putText(frame, 'now_area_acc : ' + str(area_acc), (200, 460), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 0), 2)
        frame = cv2.putText(frame, 'area_acc : ' + str(area_acc_val), (200, 500), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)
