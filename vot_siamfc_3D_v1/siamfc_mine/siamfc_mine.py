...
class TrackerSiamFC(Tracker):
    ...
    def update(self, count, img_files): 
        ...
        x = []
        xsz=self.x_sz
        instancesz=self.cfg.instance_sz
        ...
        if count == 1:
            ...
            x = [ops.crop_and_resize(
                ...
                border_value=self.avg_color) for f in self.scale_factors_init]
        else : 
            ...
            for fr, img_file in enumerate(img_files): 
                ...
                x.append(ops.crop_and_resize(img, self.center, xsz*0.94, out_size=instancesz, border_value=avgcolor))  #0.7
        ...
        scale =  (((1 - self.cfg.scale_lr) * 1.0 + self.cfg.scale_lr * scale_factors[scale_id]))*hyper_parameter
    ...
    def track(self,first_img, focal_dirs, show_imgs, box, lfs, visualize=False): 
