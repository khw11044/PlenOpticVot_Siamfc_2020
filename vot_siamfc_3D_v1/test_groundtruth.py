...
parser.add_argument('-vn', '--video_name', default='C:/Repos/vot/2020VOT_SiamFC/data/NonVideo4_1', type=str) #C:\Repos\vot\2020VOT_SiamFC\vot_My_siamfc\image
...
f = open("recode/groundtruth2.txt", 'r') #bboxone.txt  ./groundtruth1.txt
fb = open("recode/bbox2.txt", 'r')
pr = open("recode/precision2.txt",'w')
area = open("recode/rec_area2.txt",'w')
def main():
    line=[]
    total=0
    total_area_acc = 0
