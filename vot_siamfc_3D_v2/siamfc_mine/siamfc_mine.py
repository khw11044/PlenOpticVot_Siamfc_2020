        ...
        try : 
            for f, focal_dir in enumerate(focal_dirs): 
                ...
                if f == 0:
                    ...
                    boxes[f, :], response, search, scale_id = self.update(f, picked) 
                else :
                    focal_planes = focal_plane[scale_id-1: scale_id + 1+1] #3개씩
                    boxes[f, :], response, search, scale_id = self.update(f, focal_planes) 
