...
parser.add_argument('-vn', '--video_name', default='C:/Repos/vot/2020VOT_SiamFC/data/NonVideo4_0', type=str) 
...
f = open("recode/groundtruth1.txt", 'r') #bboxone.txt  ./groundtruth1.txt
fb = open("recode/bbox1.txt", 'r')
pr = open("recode/precision1.txt",'w')
area = open("recode/rec_area1.txt",'w')
def main():
    line=[]
    total=0
    total_area_acc = 0
