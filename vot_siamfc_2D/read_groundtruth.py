#python read_groundtruth.py -vn C:/Repos/vot/2020VOT_SiamFC/vot_My_siamfc/image
import os
import argparse
import cv2
import numpy as np
...
parser.add_argument('-vn', '--video_name', default='C:/Repos/vot/2020VOT_SiamFC/data/NonVideo4', type=str) #C:\Repos\vot\2020VOT_SiamFC\vot_My_siamfc\image
...
f = open("recode/groundtruth1.txt", 'r') #./groundtruth1.txt
def main():
    line=[]
