...
class TrackerSiamFC(Tracker):
    ...
    def init(self, img, box):
        ...
        self.scale_factors_init = self.cfg.scale_step ** np.linspace(   
            -(self.cfg.scale_num_init // 18),                       
            self.cfg.scale_num_init // 18, self.cfg.scale_num_init)
    ...
    def update(self, count, img_files): 
        ...
        for fr, img_file in enumerate(img_files): 
            ...
            x.append(ops.crop_and_resize(img, self.center, xsz*0.94, out_size=instancesz, border_value=avgcolor)) 
        ...
        return box,responses,search,int(png.split('.')[-2])   
